  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: "radial-gradient(ellipse 80% 60% at 50% 0%, #064e3b18, transparent), radial-gradient(ellipse 60% 40% at 80% 80%, #1e3a5f20, transparent)",
        pointerEvents: "none",
      }} />
      <div style={{
        position: "absolute", inset: 0,
        backgroundImage: "linear-gradient(#6ee7b708 1px, transparent 1px), linear-gradient(90deg, #6ee7b708 1px, transparent 1px)",
      ...
      >
        ...
        <div style={{
          ...
          background: "#064e3b40", border: "1px solid #6ee7b730",
          borderRadius: 99, padding: "6px 18px",
          marginBottom: "2rem", fontSize: 13, color: "#6ee7b7",
        }}>
          <span style={{
        ...
        <p style={{
          ...
          <strong style={{ color: "#e2e8f0" }}>AI motorumuz anlık analiz</strong>{" "}
        ...
        <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
          ...
          <button
            ...
            style={{
              ...
              padding: "16px 32px", fontSize: "1.05rem",
        ...
        {/* Stats */}
        <div style={{
          marginTop: "5rem", display: "flex",
          gap: 48, justifyContent: "center", flexWrap: "wrap",
        }}>
          {STATS.map(([value, label]) => (
            <div key={label} style={{ textAlign: "center" }}>
              <div style={{ fontSize: "1.8rem", fontWeight: 900, color: "#6ee7b7", fontFamily: "monospace" }}>
                {value}
              </div>
